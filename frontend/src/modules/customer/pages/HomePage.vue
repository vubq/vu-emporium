      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div class="text-center">
          <h1 class="text-5xl md:text-7xl font-display font-bold text-white mb-6 animate-fade-in">
            Welcome to <span class="block mt-2">Vu Emporium</span>
          </h1>
          <p class="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto animate-slide-up">
            Discover amazing products at unbeatable prices. Your premier destination for quality and style.
          </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section class="py-16 -mt-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="text-center p-6 bg-white rounded-2xl shadow-card hover:shadow-card-hover transition-all duration-300 group">
            ...
            <h3 class="font-display font-bold text-lg mb-2">Quality Guaranteed</h3>
            <p class="text-gray-600">Premium products with verified quality</p>
          </div>
          ...
          <div class="text-center p-6 bg-white rounded-2xl shadow-card hover:shadow-card-hover transition-all duration-300 group">
            ...
            <h3 class="font-display font-bold text-lg mb-2">Best Prices</h3>
            <p class="text-gray-600">Competitive pricing on all items</p>
          </div>
        </div>
      </section>
      ...
      <section id="featured" class="py-16">
        <div class="text-center mb-12">
          <h2 class="text-4xl font-display font-bold gradient-text mb-4">Featured Products</h2>
